...
save_dir = 'checkpoints/text_bert_dnn'
...
def train():
    ...
    tensorboard_dir = 'tensorboard/text_bert_dnn'
...
if __name__ == '__main__':
    if len(sys.argv) != 2 or sys.argv[1] not in ['train', 'test']:
        raise ValueError("""usage: python run_bert_dnn.py [train / test]""")
